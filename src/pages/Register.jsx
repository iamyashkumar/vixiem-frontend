  ...
  return (
    <PageTransition>
      <div className="min-h-screen flex bg-transparent text-slate-800 dark:text-slate-200 transition-colors duration-200 pt-20">
        ...
        <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-transparent border-l border-slate-200/80 dark:border-slate-800/80 items-start justify-center transition-colors duration-300">
